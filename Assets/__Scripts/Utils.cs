...
public class Utils : MonoBehaviour
{
	...
	// While most Béier curves are 3 or 4 points, it is possible to have
	...
	static public string AddCommasToNumber (int n)
	{
		...
		while (n>0) {
			...
			// NOTE: It is somewhat faster to use a StringBuilder or a List<String> which is then concatenated using String.Join().
