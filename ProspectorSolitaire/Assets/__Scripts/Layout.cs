...
//The SlotDef class is not a sublass of MonoBehavior, so it doesn't need a seperate C# file
...
public class Layout : MonoBehaviour {
	...
	public void ReadLayout(string xmlText){
		...
		for (int i = 0; i<slotsX.Count; i++) {
			...
			//The layers are used to make sure that athe correct cards are on top of the others.
			//In Unity2D all of our assets are effectively at the same Z depth so the layer is used to differentiate between them
