...
public class Scoreboard : MonoBehaviour
{
	...
	//This will instantiate a new FloatingScore GameObject and intialize it.
	// It also returns a pointer to the FloatingScore created that the calling function co do more with it (like set fontSizes, etc.)
